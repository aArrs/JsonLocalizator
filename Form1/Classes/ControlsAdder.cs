...
public class ControlsAdder : IAddControls
{
    ...
    public void AddResxLabel(Panel panel, List<KeyValuePair<string, string>> sourceList, List<Control> labelList)
    {
        panel.SuspendLayout();
        var y = 0;
        foreach (var item in sourceList)
    ...
    public void AddResxImmutableTextBox(Panel panel,List<KeyValuePair<string, string>> sourceList, List<Control> immutTextboxList)
    {
        panel.SuspendLayout();
        var y = 0;
        foreach (var item in sourceList)
    ...
    public void AddResxTextBox(Panel panel, List<KeyValuePair<string, string>> translatedList,
        List<Control> controlsToRemove)
    {
        panel.ResumeLayout();
        var y = 0;
        foreach (var item in translatedList)    
